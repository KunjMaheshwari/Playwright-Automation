...
test('Assertion Test', async({page}) =>{
    ...
    const maleRadioBtn = page.locator("//input[@id='gender-male']");
    await maleRadioBtn.click();
    await expect(maleRadioBtn).toBeChecked();

    const newsletterCheckbox = page.locator("(//input[contains(@id, 'NewsLetterSubscriptions')])[2]");
    ...
    const registerHeading = page.locator("//div[@class='page-title']/child::h1");
